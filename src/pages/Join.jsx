...
import { ArrowRight, FlaskConical, LogIn, Target, Clock, Ear, FileText, Zap, CheckCircle, CalendarDays, MapPin, Wrench, BookOpen, Bell, Smartphone, Megaphone } from "lucide-react";
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative z-10">
        <div className="w-full max-w-sm">
          <div
            ...
            <div className="mb-6 flex items-start gap-2 rounded-xl bg-amber-400/10 border border-amber-300/30 px-3.5 py-2.5">
              <Megaphone className="w-4 h-4 text-amber-300 shrink-0 mt-0.5" />
              <p className="text-amber-200 text-xs leading-relaxed">
                We're moving to <span className="font-bold text-amber-100">dhhitinerant.com</span> — your account will be migrated automatically.
              </p>
            </div>
