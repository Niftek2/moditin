...
import { Check, X, Users, User, Building2, GraduationCap, Globe } from "lucide-react";
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="bg-[#F7F3FA] rounded-xl p-4">
                ...
                <p className="text-xs text-green-600 mt-1 font-medium">
                  ✓ {selectedPlan.trial} — your card will not be charged until {selectedPlan.trialDays === 7 ? "7 days" : "14 days"} from now
                </p>
              </div>
