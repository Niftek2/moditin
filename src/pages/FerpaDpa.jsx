    ...
    <div className="min-h-screen bg-[#F7F3FA]">
      ...
      <div className="max-w-4xl mx-auto px-6 py-10 space-y-8">
        ...
        <p className="text-center text-xs text-[var(--modal-text-muted)] pb-8">
          Questions? Contact <a href="mailto:privacy@modaleducation.com" className="text-[#6B2FB9] hover:underline">privacy@modaleducation.com</a> · Modal Education, LLC · Effective February 23, 2026
        </p>
      </div>
    </div>
  );
