  ...
  return (
    <div className="min-h-screen bg-[var(--modal-bg)]" role="application" aria-label="Modal Education Platform">
      ...
      <div className="fixed top-4 right-4 z-40">
        <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6998a9f042c4eb98ea121183/8fc967743_LogoNoScript.png" alt="Modal Itinerant" className="h-10 w-10 object-contain" />
      </div>
