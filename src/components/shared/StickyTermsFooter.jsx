  ...
  return (
    <>
      <div className="fixed bottom-0 left-0 right-0 z-40 flex justify-center lg:pl-64">
        <div className="w-full max-w-7xl px-4 lg:px-8 py-2 flex justify-end">
          <button
            onClick={() => setShowTerms(true)}
            className="text-xs text-[var(--modal-text-muted)] hover:text-[#400070] underline underline-offset-2 transition-colors"
          >
