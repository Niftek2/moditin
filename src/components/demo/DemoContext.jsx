...
const SEED_DATA = {
  students: [
    { id: "demo-s1", studentInitials: "A.T.", gradeBand: "3-5", communicationModality: "LSL", readingLevelBand: "Developing (3-5)", colorTag: "blue", serviceDeliveryModel: "InPerson", iepAnnualReviewDate: "2026-04-15", directMinutes: 30, directMinutesFrequency: "Weekly", indirectMinutes: 15, indirectMinutesFrequency: "Weekly", notes: "Responds well to structured auditory tasks. Prefers quiet environments.", warmNotes: "Loves science and dinosaurs — great topic for auditory activities!", displayOrder: 0, primaryEligibility: "Hearing Impairment", schoolCode: "RDGE" },
