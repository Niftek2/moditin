...
/**
 * Bulk export: accepts an array of committed (isDraft: false) events and
 * triggers download of a single .ics file containing all of them.
 */
export function downloadBulkICS(events, filename = "schedule.ics") {
