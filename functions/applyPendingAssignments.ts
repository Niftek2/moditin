...
<table style="width:100%;border-collapse:collapse;font-size:15px">
  ...
  <tr><td style="padding:8px 0;font-weight:bold;color:#400070">State</td><td style="padding:8px 0">${district.institutionState || '(not provided)'}</td></tr>
  <tr><td style="padding:8px 0;font-weight:bold;color:#400070">District</td><td style="padding:8px 0">${districtName}</td></tr>
