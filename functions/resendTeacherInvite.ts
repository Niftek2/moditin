...
Deno.serve(async (req) => {
  try {
    ...
    // Check if user already exists (edge case: they signed up after the initial invite)
      ...
      <table role="presentation" width="100%" style="max-width:560px;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="padding:32px 40px;">
            ...
            <p style="margin:0 0 28px;font-size:15px;color:#3d3d3d;line-height:1.7;">Just a reminder — your <strong style="color:#400070;">Modal Itinerant</strong> license is active and ready. ${isExisting ? "Your account already exists — just log in." : "You haven't created your account yet. It only takes a minute:"}</p>
